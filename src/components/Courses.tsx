  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-6">Courses</h2>
        ...
        <div className="space-y-2 sm:space-y-3">
          {state.courses.length === 0 ? (
            <p className="text-gray-500 text-center py-8 text-sm sm:text-base">No courses added yet</p>
          ) : (
            state.courses.map((course) => (
              ...
              >
                {editingId === course.id ? (
                  ...
                  <>
                    <span className="flex-1 text-gray-800 font-medium text-sm sm:text-base break-words">{course.name}</span>
