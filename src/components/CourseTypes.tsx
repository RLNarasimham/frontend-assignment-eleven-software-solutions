  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 sm:p-6 transition-colors duration-200">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4 sm:mb-6 transition-colors">Course Types</h2>
        ...
        <div className="space-y-2 sm:space-y-3">
          {state.courseTypes.length === 0 ? (
            <p className="text-gray-500 dark:text-gray-400 text-center py-8 text-sm sm:text-base transition-colors">No course types added yet</p>
          ) : (
            state.courseTypes.map((courseType) => (
              ...
              >
                {editingId === courseType.id ? (
                  ...
                  <>
                    <span className="flex-1 text-gray-800 dark:text-gray-100 font-medium text-sm sm:text-base break-words transition-colors">{courseType.name}</span>
